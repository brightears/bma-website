...
const PRESENTATION = "beat-breeze-id";
...
if (
  ...
  throw new Error("The Indonesian narration script must contain all 15 Beat Breeze slides.");
}
...
try {
  ...
  const manifest = {
    ...
    status: "official-indonesian-narrated-presentation",
    ready: true,
    generatedAt,
    releaseId,
    publicationStatus:
      "Official unlinked, noindex Indonesian Beat Breeze presentation with complete slide-linked Indonesian narration.",
    coverage: {
    ...
    source: {
      ...
      englishDeckSha256,
      officialDeckPath: "public/presentations/beat-breeze-id.html",
      officialDeckSha256,
      scriptPath:
        "public/presentations/narration/beat-breeze-id/script.json",
      scriptSha256,
      copyPath: "public/presentations/narration/beat-breeze-id/copy.json",
      copySha256,
    },
    voice: {
      provider: "google-gemini",
