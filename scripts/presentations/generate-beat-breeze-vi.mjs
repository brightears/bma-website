...
const PRESENTATION = "beat-breeze-vi";
...
if (
  ...
  throw new Error("The Vietnamese narration script must contain all 15 Beat Breeze slides.");
}
...
try {
  ...
  const manifest = {
    ...
    status: "official-vietnamese-narrated-presentation",
    ready: true,
    generatedAt,
    releaseId,
    publicationStatus:
      "Official unlinked, noindex Vietnamese Beat Breeze presentation with complete slide-linked Vietnamese narration.",
    coverage: {
    ...
    source: {
      ...
      englishDeckSha256,
      officialDeckPath: "public/presentations/beat-breeze-vi.html",
      officialDeckSha256,
      scriptPath:
        "public/presentations/narration/beat-breeze-vi/script.json",
      scriptSha256,
      copyPath: "public/presentations/narration/beat-breeze-vi/copy.json",
      copySha256,
    },
    voice: {
      provider: "google-gemini",
