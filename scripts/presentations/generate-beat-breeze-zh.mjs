...
if (
  ...
  throw new Error("The Simplified Chinese narration script must contain all 15 Beat Breeze slides.");
}
...
try {
  ...
  const manifest = {
    ...
    status: "official-simplified-chinese-narrated-presentation",
    ready: true,
    generatedAt,
    releaseId,
    publicationStatus:
      "Official unlinked, noindex Simplified Chinese Beat Breeze presentation with complete slide-linked Mandarin narration.",
    coverage: {
    ...
    source: {
      ...
      englishDeckSha256,
      officialDeckPath: "public/presentations/beat-breeze-zh.html",
      officialDeckSha256,
      scriptPath:
        "public/presentations/narration/beat-breeze-zh/script.json",
      scriptSha256,
      copyPath: "public/presentations/narration/beat-breeze-zh/copy.json",
      copySha256,
    },
    voice: {
      provider: "google-gemini",
