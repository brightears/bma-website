...
const COPY = new Map([
  ...
  ["Licensed library, growing every week", "คลังเพลงที่ได้รับอนุญาต เพิ่มใหม่ทุกสัปดาห์"],
  ...
  ["Free team seats + brand-lock", "บัญชีทีมฟรี + brand-lock"],
  ...
  ["Licensed for business", "สิทธิ์พร้อมสำหรับธุรกิจ"],
  [
    "100% royalty-free and licensed for commercial use worldwide — proof of licence one QR scan away, no paperwork to chase.",
    "เพลงปลอดค่าลิขสิทธิ์ 100% พร้อมสิทธิ์สำหรับการใช้เชิงพาณิชย์ทั่วโลก — แสดงหลักฐานได้ด้วย QR เดียว ไม่ต้องไล่หาเอกสาร",
  ],
  ...
  ["Quiet hours", "ช่วงเวลาที่ต้องการความเงียบ"],
  [
  ...
  ["Daily energy curve", "เส้นพลังงานประจำวัน"],
  ["Calm mornings, lively lunch, relaxed late nights — built through the day.", "เช้าสงบ กลางวันคึกคัก ดึกผ่อนคลาย — ไล่ระดับตลอดทั้งวัน"],
  ["Rainy-day cozy", "วันฝนตกที่อบอุ่น"],
  ["Switch to warm, cozy music whenever it's raining at your venue.", "เปลี่ยนเป็นเพลงอบอุ่นนุ่มนวลเมื่อฝนตกที่สถานที่ของคุณ"],
  ["Beat the heat", "คลายความร้อน"],
  ...
  ["Respect prayer times", "เคารพเวลาละหมาด"],
  ["Gently pause the music during each of the five daily prayers, then resume.", "หยุดเพลงอย่างนุ่มนวลในช่วงละหมาดทั้งห้าครั้ง แล้วเล่นต่อ"],
  ["Playlist by time of day", "เพลย์ลิสต์ตามช่วงเวลา"],
  ...
  ["Seasonal &amp; holidays", "เทศกาลและวันหยุด"],
  ["Festive music for a set date range, from the event scheduler.", "กำหนดเพลงเทศกาลตามช่วงวันที่ผ่านตัวจัดตารางอีเวนต์"],
  ["Or build your own —", "หรือสร้างกฎของคุณเอง —"],
  ["triggers for weather, temperature, footfall &amp; occupancy, and prayer times.", "ใช้สภาพอากาศ อุณหภูมิ จำนวนคน ความหนาแน่น และเวลาละหมาดเป็นตัวกระตุ้น"],
  ["Runs fully offline — prayer pauses included", "ทำงานออฟไลน์เต็มรูปแบบ — รวมการหยุดตามเวลาละหมาด"],
  ["Your Music Director", "Music Director ของคุณ"],
  ...
  ["Learns every zone from real behavior", "เรียนรู้แต่ละโซนจากพฤติกรรมจริง"],
  ...
  ["Proof, not promises", "ใช้หลักฐาน ไม่ใช่คำสัญญา"],
  ...
  ["Tonight's suggestion · Pool Bar", "คำแนะนำคืนนี้ · Pool Bar"],
  ["Max 3 / week", "สูงสุด 3 ครั้ง / สัปดาห์"],
  ...
  ["Per-zone permissions enforced server-side — lock a zone so the brand playlist can't be changed.", "สิทธิ์รายโซนบังคับใช้ที่เซิร์ฟเวอร์ ล็อกโซนเพื่อไม่ให้เปลี่ยนเพลย์ลิสต์ของแบรนด์"],
  ["A proactive AI assistant", "ผู้ช่วย AI เชิงรุก"],
  ...
  ["A completely hands-off experience.", "ประสบการณ์แบบให้เราดูแลทั้งหมด"],
  ["Bespoke music design", "ออกแบบเพลงเฉพาะแบรนด์"],
  ...
  ["Group-wide oversight and control", "ดูแลและควบคุมทั้งกลุ่ม"],
  ["Brand-locked zones across properties, custom contracts, and invoicing.", "โซนที่ล็อกตามแบรนด์ทุกสาขา สัญญาเฉพาะ และการออกใบแจ้งหนี้"],
  ["Trust · engineering", "ความไว้วางใจ · วิศวกรรม"],
  ["Engineered to never", "ออกแบบมาให้เพลง"],
  ["go silent.", "ไม่เคยหยุด"],
  ["The player is built around one promise: the room never notices a problem.", "เครื่องเล่นสร้างขึ้นรอบคำสัญญาหนึ่งข้อ คือคนในห้องไม่ควรรู้ว่ามีปัญหา"],
  ["True offline", "ออฟไลน์ได้จริง"],
  ...
  ["Self-healing players", "เครื่องเล่นฟื้นตัวได้เอง"],
  ...
  ["Announcement delivery receipts", "ใบยืนยันการส่งประกาศ"],
  ...
  ["Licence proof, live", "หลักฐานสิทธิ์แบบสด"],
  ["A live-verifiable licence certificate with a QR code — hand any inspector real-time proof, on the spot.", "ใบรับรองสิทธิ์ที่ตรวจสอบสดได้ด้วย QR code แสดงหลักฐานให้ผู้ตรวจสอบได้ทันที"],
  ["Why Beat Breeze", "ทำไมต้อง Beat Breeze"],
  ...
  ["Software with", "ซอฟต์แวร์ที่มี"],
  ["people behind it.", "คนจริงอยู่เบื้องหลัง"],
  ["Beat Breeze is built by BMAsia — a team that has designed music for venues since 2002 and operates globally today. The AI is trained by real music designers, and real humans answer when you need them.", "Beat Breeze สร้างโดย BMAsia ทีมที่ออกแบบเพลงให้สถานที่ต่าง ๆ มาตั้งแต่ปี 2002 และทำงานทั่วโลกในวันนี้ AI เรียนรู้จากนักออกแบบเพลงจริง และมีคนจริงคอยตอบเมื่อคุณต้องการ"],
  ...
  ["Musicians, not just engineers", "นักดนตรี ไม่ใช่แค่วิศวกร"],
  ["The curation behind the platform comes from working music designers.", "การคัดสรรของแพลตฟอร์มมาจากนักออกแบบเพลงที่ทำงานจริง"],
  ["Humans on support, 24/7", "ซัพพอร์ตโดยคนจริง 24/7"],
  ["A real person answers — and the roadmap is driven by what operators ask for.", "มีคนจริงคอยตอบ และแผนพัฒนาขับเคลื่อนจากสิ่งที่ผู้ดูแลสถานที่ต้องการ"],
